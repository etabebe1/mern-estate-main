...
export default function ConfirmDeleteAcc({ message, onConfirm, onClick }) {
  const handleDeleteAccount = () => {
    console.log("user confirmed!");
  };

  const handleCancelDeleteAcc = () => {
    console.log("user canceled delete acc!");
  };
